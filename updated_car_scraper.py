...
class CarScraper:
    ...
    def get_filtered_cars(self, brand, model, submodel=None, filters=None, max_pages=10):
        ...
        print(f"Searching for {brand} {model} {submodel or ''} with filters: {filters}")
...
def main():
    parser = argparse.ArgumentParser(description='Updated Car Scraper with Real URL Structure')
    parser.add_argument('brand', help='Car brand (e.g., renault)')
    parser.add_argument('model', help='Car model (e.g., clio)')
    parser.add_argument('--submodel', help='Car submodel (e.g., 1.3-tce)')
    ...
    parser.add_argument('--max-km', type=int, help='Maximum kilometer')
    parser.add_argument('--min-km', type=int, help='Minimum kilometer')
